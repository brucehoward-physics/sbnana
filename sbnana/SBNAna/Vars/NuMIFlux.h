...
namespace ana
{
  ...
  // NEWER root file from Tony
  class NuMIPpfxFluxWeightNew
  {
  public:
    NuMIPpfxFluxWeightNew();
    mutable TH1* fWeight[2][2][2]; // [fhc/rhc][nue/numu][nu/nubar]
  };

  // set up to use the flux weight
  NuMIPpfxFluxWeightNew FluxWeightNuMINew;
  extern const Var kGetNuMIFluxWeightNew;
